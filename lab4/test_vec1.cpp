...
int main() {
  ...
  // test remove_matching_elements
  cout << "\nremove_matching_elements(v1, 100) should return 10 (" << remove_matching_elements(v1, 100) << ") and no 100s should be in v1\n";
  cout << "v1 is now: \n"; 
  v1.print();
  cout << "\nremove_matching_elements(v1, 35) should return 1 (" << remove_matching_elements(v1, 35) << ") and no 35s should be in v1\n";
  cout << "v1 is now: \n"; 
  v1.print();
  cout << endl;

  //for loop push_back
  cout << "push_back for loop INTERESTING!!!!!!!!!!!!!!!!!!!!!!!!!!\n";
  Vec<int> v4;
